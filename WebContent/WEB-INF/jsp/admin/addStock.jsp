                            ...
                            <div class="col-lg-6">
                                <form action="AddStock" method="post">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" placeholder="Product Name" required="" name="prodname" type="text">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" placeholder="Stock Keeping Unit" required="" name="flrlvl" type="number" step="0.01">
                                    </div>
